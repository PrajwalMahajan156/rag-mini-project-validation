...
async def upload_document(
    ...
    try:
        ...
        db_doc = models.Document(id=document_id, filename=file.filename, user_id=current_user.id)
        db.add(db_doc)
        db.commit()
...
async def chat(
    ...
    try:
        def stream_generator():
            for chunk in chat_service.get_response(query, document_id, session_id, current_user.id, db, model_id):
                yield chunk
